...
const char* ssid = "HR"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "123123123"; // Your Wifi password, in case you have open network comment the whole statement.
